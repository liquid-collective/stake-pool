...
setup_test_validator() {
  solana-test-validator \
    --clone-upgradeable-program LssoLRJHLA3T8Szwd84X3VT2pZYtGuiTEsvvwAKc6Ho \
  ...
  #solana-test-validator \
  #  --bpf-program LssoLRJHLA3T8Szwd84X3VT2pZYtGuiTEsvvwAKc6Ho ../../../target/deploy/spl_stake_pool.so \
